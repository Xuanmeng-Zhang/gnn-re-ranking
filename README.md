...
# Implementation
The paddlepaddle implementation can be find in [[PaddlePaddle]](https://github.com/PaddlePaddle/Research/tree/master/CV/GNN-Re-Ranking).

The pytorch version can be find in [[Person_reID_baseline_pytorch]](https://github.com/layumi/Person_reID_baseline_pytorch/tree/master/GPU-Re-Ranking).
